...
public class InvalidInputException extends BaseException {
    public static enum Type {
        ...
        PATIENT_NOT_FOUND(Commons.INVALID_INPUT_PATIENT_NOT_FOUND),
        UNKNOWN_DELETE_ARGUMENT(Commons.INVALID_INPUT_UNSPECIFIED_DELETE),
        END_OF_FILE(Commons.INVALID_INPUT_END_OF_FILE);
